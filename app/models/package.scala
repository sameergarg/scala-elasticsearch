...
package object models {
  ...
  implicit val recipeRead: Format[Recipe] =
    (
        (JsPath \ "name").format[String] and
        (JsPath \ "source").format[String] and
        (JsPath \ "url").format[String] and
        (JsPath \ "recipeYield").format[String] and
        (JsPath \ "prepTime").format[String] and
        (JsPath \ "cookTime").format[String] and
        (JsPath \ "datePublished").format[String] and
